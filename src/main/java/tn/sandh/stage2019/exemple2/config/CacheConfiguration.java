package tn.sandh.stage2019.exemple2.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("Exemple2");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("Exemple2");
        ...
        config.getMapConfigs().put("tn.sandh.stage2019.exemple2.domain.*", initializeDomainMapConfig(jHipsterProperties));
